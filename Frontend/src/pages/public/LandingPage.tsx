    ...
    <div className="landing-page-root w-full font-body-md text-on-surface bg-white relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-32 overflow-hidden hero-gradient px-4">
        ...
        <div className="max-w-container-max mx-auto grid md:grid-cols-2 gap-16 items-center relative z-10 w-full">
          ...
          {/* Admission Command Center Visual */}
        ...
        <div className="max-w-container-max mx-auto w-full">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
              ...
              {/* Step 4 */}
              <div className="group">
                <div className="w-20 h-20 bg-secondary-container rounded-3xl flex items-center justify-center mb-8 mx-auto group-hover:scale-110 transition-all shadow-lg shadow-secondary/30">
                  <span className="material-symbols-outlined text-4xl text-white">notifications_active</span>
                </div>
                <div className="text-center">
